...
function titulo() {
  console.log(
    "\x1b[38;2;250;128;114m" +
      ...
      "\x1b[0m" +
      "\x1b[36m" +
      "   ____ _____ ____   _____ ___ _   _ ____  _____ ____   " +
      "\x1b[0m" +
      "\x1b[38;2;250;128;114m" +
      "║\n" +
      "║" +
      ...
      "\x1b[0m" +
      "\x1b[36m" +
      "  |____/ |_| \\____| |_|   |___|_| \\_|____/|_____|_| \\_\\ " +
      "\x1b[0m" +
      "\x1b[38;2;250;128;114m" +
      "║\n" +
      "║" +
      ...
      "║\n" +
      "╚══════════════════════\x1b[32m" +
      "Investidor Internacional - v0.7" +
      "\x1b[0m\x1b[38;2;250;128;114m═══╝" +
      "\x1b[0m"
  );
}
...
async function menu() {
  ...
  //       2
  //     )} - Escolher uma porcentagem, ${chalk.cyan(
  //       3
  //     )} - Escolher minimo, ${chalk.cyan(4)} - Dividir em blocos, ${chalk.cyan(
  //       5
  //     )} - Dividir em blocos (Randomico)): `
  ...
  switch (answer) {
    ...
    case "4":
      ...
      const numBlocos =
        parseInt(
          await fazerPergunta(
            `Digite o número de blocos para dividir o intervalo (ou pressione Enter para usar ${numCPUs} blocos, com base no número de CPUs disponíveis): `
          )
        ) || numCPUs;
        ...
        return new Promise((resolve, reject) => {
          ...
          worker.on("message", (message) => {
            ...
            if (message.completed) {
              console.log(
                `Bloco ${message.blocoId} completado sem encontrar chave.`
              );
              resolve();
            }
          });
      ...
      const promises = blocos.map((bloco, index) =>
        criarWorker(bloco, index + 1)
      );
    ...
    case "5":
      ...
      const blocosRandom = await escolherPorcentagemBlocos(
        min,
        max,
        numBlocosRandom
      );
      ...
      const promisesRandom = blocosRandom.map((bloco, index) =>
        criarWorkerRandom(bloco, index + 1)
      );
